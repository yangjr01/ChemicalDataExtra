...
import { List, Plus, Flask } from "@phosphor-icons/react";
              ...
              <div className="flex-grow flex flex-col min-w-[235px] min-h-0">
                <div className="relative h-[calc(100%-60px)] flex flex-col w-full justify-between pt-[10px] overflow-y-scroll no-scroll">
                  <div className="flex flex-col gap-y-[14px]">
                    ...
                    {/* Chemical Literature Management Link */}
                    <Link
                      to={paths.chemical.literature()}
                      className="flex gap-x-2 items-center text-theme-text-secondary light:text-slate-800 hover:text-theme-text-main light:hover:text-slate-900 transition-all duration-300"
                    >
                      <div className="flex gap-x-2 items-center w-full">
                        <Flask className="h-5 w-5 shrink-0" />
                        <p className="text-sm font-semibold">
                          {t("sidebar.chemical-literature")}
                        </p>
                      </div>
                    </Link>
                    <ActiveWorkspaces />
            ...
            <div className="h-full flex flex-col w-full justify-between pt-4 ">
              <div className="h-auto md:sidebar-items">
                <div className=" flex flex-col gap-y-4 overflow-y-scroll no-scroll pb-[60px]">
                  ...
                  />
                  {/* Chemical Literature Management Link - Mobile */}
                  <Link
                    to={paths.chemical.literature()}
                    className="flex gap-x-2 items-center text-theme-text-secondary light:text-slate-800 hover:text-theme-text-main light:hover:text-slate-900 transition-all duration-300"
                  >
