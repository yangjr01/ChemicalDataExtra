...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // Chemical Data Extraction Routes
      {
        path: "/chemical/literature",
        lazy: async () => {
          const { LiteratureManage } = await import("@/pages/Chemical");
          return { element: <PrivateRoute Component={LiteratureManage} /> };
        },
      },
      {
        ...
        lazy: async () => {
          ...
          return { element: <PrivateRoute Component={ExtractionFlow} /> };
        },
      },
      {
        path: "/chemical/data/:articleId",
        lazy: async () => {
          const { DataViewer } = await import("@/pages/Chemical");
          return { element: <PrivateRoute Component={DataViewer} /> };
        },
      },
      // 新版化学提取页面
      {
        path: "/chemical/extract/:articleId",
        lazy: async () => {
          const { ChemicalExtractionPage } = await import("@/pages/Chemical");
